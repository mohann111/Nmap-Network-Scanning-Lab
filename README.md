# Nmap-Network-Scanning-LabThis project demonstrates network scanning with Nmap on a local subnet, explains different types of Nmap scans, and showcases saving results as both text and HTML reports.
